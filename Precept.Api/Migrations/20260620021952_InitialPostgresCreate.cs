    ...
    public partial class InitialPostgresCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BehavioralStories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BehavioralStories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtractedKeyWords = table.Column<List<string>>(type: "text[]", nullable: false),
                    MissingKeyWords = table.Column<List<string>>(type: "text[]", nullable: false),
                    YourMatchScore = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateLastContact = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FollowUpDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ResumeVersion = table.Column<string>(type: "text", nullable: false),
